...
scaleList1=[1,1,1,1,1]
#scaleList2=[0.5,0.75,1,1.2,1.4]#[1,1,1,1,1]
scaleList3=[0.5,0.75,1,1.25,1.5]#[1,1,1,1,1]
scaleList=[[scaleList1[i],
            1,
            1,
            scaleList3[i]] for i in range(len(scaleList1))]
...
#plt.text(4000,1.3,r'$V=0.17\alpha e^{1.16 \kappa}$',fontsize=16)
...
plt.savefig('4A.svg',bbox_inches='tight')
...
#plt.text(1.05,0.85,r'$V=0.17\alpha e^{1.16 \kappa}$',fontsize=16)
plt.xlabel(r'Growth rate $\kappa$ $[h^{-1}] $',fontsize=18)
plt.ylabel(r'Efficiency $\mathcal{E}$',fontsize=18)   
plt.margins(x=0,y=0.05)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.savefig('4B.svg',bbox_inches='tight')
